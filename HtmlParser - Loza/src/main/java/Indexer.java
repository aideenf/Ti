...
public class Indexer
{
    ...
    protected void firstPass(Index ind) throws IOException
    {
        ...
        System.out.println("Path to index: " + pathToIndex.getAbsolutePath());
        System.out.println("Path to collection: " + pathToCollection.getAbsolutePath());
        System.out.println("Path to processor: " + docProcessor.toString());
